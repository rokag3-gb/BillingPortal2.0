...
from portal.views import payment, dashboard, index, preference, profile, messages, InvoiceList
...
urlpatterns = [
    ...
    path('invoices/', login_required(InvoiceList.as_view(template_name="portal/invoices.html")), name='invoices'),
